...
urlpatterns = [
	...
	path('meus_itens/categoria/<str:cat>', views.meus_itens_categoria, name='meus_itens_categoria'),
	path('home/categoria/<str:cat>', views.home_categoria, name="home_categoria" ),
